...
constexpr int column_bytes(int n_pixels) { return 16 + (n_pixels * pixel_bytes) + 4; }

constexpr int packet_bytes(int n_pixels) { return cols_per_packet * column_bytes(n_pixels); }
...
inline const uint8_t* nth_px(int n, const uint8_t* col_buf) { return col_buf + 16 + (n * pixel_bytes); }
